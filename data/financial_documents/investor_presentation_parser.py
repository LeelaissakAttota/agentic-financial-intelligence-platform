"""
Investor Presentation Parser (Financial Documents Module).

Parses investor presentations to extract key financial highlights, strategic
initiatives, growth drivers, guidance, and capital allocation information.
"""
...
from .parser import parse_financial_pdf, ParserResult
